...
let imagesList = ["./images/HalfLife.jpg","./images/завантаження.jpg","./images/roughing-it-in-an-rv.jpg","./images/TowerB.jpg","./images/TDS.jpg","./images/escapist.jpg","./images/Superworlbox.jpg"];
let i = 0;
function leftClick() {
